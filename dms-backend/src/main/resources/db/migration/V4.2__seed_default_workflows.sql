...
INSERT INTO workflow_definitions (name, description, category, is_active, created_at, updated_at)
VALUES
    ('Purchase Approval', 'Approval workflow for purchase related documents', 'Purchase', TRUE, NOW(), NOW()),
    ('Leave Approval', 'Approval workflow for leave requests', 'HR', TRUE, NOW(), NOW()),
    ('Contract Approval', 'Approval workflow for contract documents', 'Legal', TRUE, NOW(), NOW())
...
INSERT INTO workflow_steps (workflow_definition_id, step_number, approval_level, role, timeout_hours, created_at, updated_at)
