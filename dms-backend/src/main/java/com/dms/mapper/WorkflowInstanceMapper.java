...
public interface WorkflowInstanceMapper {
    ...
    @Mapping(target = "currentStepName", source = "currentStep.role")
    @Mapping(target = "currentApproverId", source = "currentApprover.id")
    @Mapping(target = "currentApproverName", source = "currentApprover.fullName")
    ...
    @Mapping(target = "stepName", source = "workflowInstance.currentStep.role")
    ...
    @Mapping(target = "submittedByName", source = "workflowInstance.submittedBy.fullName")
